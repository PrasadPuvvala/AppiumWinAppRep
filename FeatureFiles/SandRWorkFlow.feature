...
 	When [Verify StorageLayout Scenario By Changing Date and Confirm Cloud Icon "<DeviceId>" and "<DeviceLeft>" and "<DeviceLeftSlNo>"and"<Devicetype>"]
	...
	| NX977-DWC | 2300806645     | Yes     | Right       | Left       | Rechargeable     |
	 #| NX960S-DRWC | 2300803315     | Yes     | Right    | Left        |Rechargeable      |
	#| RU960-DRWC | 4483181561     | Yes     | Right       | Left      |Rechargeable      |
	#| RE961-DRWC | 2156716948     | Yes     | Right       | Left      |D1rechargeableWired|
...
Scenario Outline: 06Test Case ID 1104002: Verify HI capture/restoration report
	...
	#| LT988-DW | 1700800149     | Yes     | Right       | Left        |    Wired         |      capture          |      restore   |
    ...
    | NX977-DWC | 2300806645     | Yes     | Right       | Left       | Rechargeable |           capture           |      restore  |
	  #| NX960S-DRWC | 2300803315     | Yes     | Right    | Left        |Rechargeable      |      capture          |      restore  |
	#| RU960-DRWC | 4483181561     | Yes     | Right       | Left      |Rechargeable      |      capture           |      restore  |
	 #| RE961-DRWC | 2156716948     | Yes     | Right       | Left      |D1rechargeableWired|      capture           |     restore   |
...
Scenario Outline: 07Test Case ID 1105498: Verify that S&R Tool properly sets listening test settings
				...
				| DeviceId  | DeviceLeftSlNo | FlashHI | DeviceRight | DeviceLeft | DeviceSlNo | Devicetype |
				 ...
				 #| RT961-DRWC  | 2000816936     | Yes     | Right       | Left       | 2000816934 | Rechargeable |
				  #| NX960S-DRWC | 2300803315     | Yes     | Right       | Left       | 2300803297 |Rechargeable |
				  | NX977-DWC | 2300806645     | Yes     | Right       | Left       | 2300806646 |Rechargeable |
				  #| RU960-DRWC  | 4483181561     | Yes     | Right       | Left       | 4483070777 | Rechargeable |
				  #| RE961-DRWC | 2156716948     | Yes     | Right       | Left      |2156716949 |D1rechargeableWired|



@tag08

Scenario Outline: 08Test case ID 1629628: Verify that firmware is upgraded if conditions apply
...
#	| LT961-DRW-UP | Left       | Right       | Device A | Device B | Device C | Device D | Temp       | Yes      | No         | 1700800900 | NoDev    | 2000800436     | Yes     | Wired    |
	#| LT988-DW | Left       | Right       | Device A | Device B | Device C | Device D | Temp       | Yes      | No         | 1700800066 | NoDev    | 1700800149     | Yes     | Wired    |
 	#| RE961-DRWC | Left       | Right       | Device A | Device B | Device C | Device D | Temp       | Yes      | No         | 2156716949 | NoDev    | 2156716948       | Yes     | D1rechargeableWired    |
    ...
    | NX977-DWC | Left       | Right       | Device A | Device B | Device C | Device D | Temp       | Yes      | No         | 2300806646 | NoDev    | 2300806645     | Yes     |Rechargeable |
	 #| NX960S-DRWC | Left       | Right       | Device A | Device B | Device C | Device D | Temp       | Yes      | No         | 2300803297 | NoDev    | 2300803315     | Yes     |Rechargeable |
	#| RU960-DRWC | Left       | Right       | Device A | Device B | Device C | Device D | Temp       | Yes      | No         | 4483070777 | NoDev    | 4483181561     | Yes     |Rechargeable |

@tag09

Scenario Outline: 09Test Case ID 1629629: Verify that firmware is downgraded if conditions apply
...
#	| LT961-DRW-UP | Left       | Right       | Device A | Device B | Device C | Device D | Temp       | Yes      | No         | 1700800900 | NoDev    | 2000800436     | Yes     | Wired    |
   ...
   | NX977-DWC | Left       | Right       | Device A | Device B | Device C | Device D | Temp       | Yes      | No         | 2300806646 | NoDev    | 2300806645     | Yes     |Rechargeable |
	...
	Scenario Outline: 10Test Case ID 1105470: Verify the data saved during capture and cleaning in Camelot Cloud
...
Examples:
	...
	#| NX977-DWC | 2300806547     | Yes     | Right       | Left       | 2300806546 | capture       |Rechargeable |
	 #| NX960S-DRWC | 2300803315     | Yes     | Right       | Left       | 2300803297 |capture      |Rechargeable |
	...
	#| RE961-DRWC  | 2156716948     | Yes     | Right       | Left       | 2156716949  | capture | D1rechargeableWired |


		@tag11

	Scenario Outline: 11Test Case ID 1101758: Verify device information is uploaded to Camelot cloud correctly
...
    When [Verify StorageLayout Scenario By Changing Date and Confirm Cloud Icon "<DeviceId>" and "<DeviceLeft>" and "<DeviceLeftSlNo>"and"<Devicetype>"]
	...
	#| RT961-DRWC  | 2000816936     | Yes     | Right       | Left       | 2000816934  | service records | Rechargeable |
	 ...
	 #| NX960S-DRWC | 2300803315     | Yes     | Right       | Left       | 2300803297  |service records  | Rechargeable |
	#| RU960-DRWC  | 4483181561     | Yes     | Right       | Left       | 4483070777  | service records | Rechargeable |
	#| RE961-DRWC | 2156716948     | Yes     | Right       | Left     | 2156716949    |service records | D1rechargeableWired|

	
	
	@tag12

	Scenario Outline: 12Test Case ID 1105521: Verify the data saved during restore in Camelot Cloud
 ...
 #   When [Perform Restore with above captured image "<DeviceId>" and "<DeviceLeftSlNo>"and"<Devicetype>" and "<DeviceLeft>"]
	...
	| NX977-DWC | 2300806645     | Yes     | Right       | Left       | 2300806646 | restore     |Rechargeable |
	 #| NX960S-DRWC | 2300803315     | Yes     | Right       | Left       | 2300803297 |restore    |Rechargeable |
	#| NX977-DWC | 2300806645     | Yes     | Right       | Left       | 2300806646 | restore      |Rechargeable |
	#| RU960-DRWC  | 4483181561     | Yes     | Right       | Left       | 4483070777 | restore    | Rechargeable |
	#| RE961-DRWC | 2156716948     | Yes     | Right       | Left     | 2156716949    |restore    | D1rechargeableWired|
		
@tag13

	Scenario Outline: 13Test Case ID 1103983: Verify cloud icon is shown when device information in saved in cloud
...
Scenario Outline: 14Test Case ID 1105696: Verify that fitting data is properly restored during restoration on new device (RTS)
...
#	 | LT961-DRW-UP | Left       | Right       | Device A | Device B | Device C | Device D       | Yes      | No         | 1700800900 | NoDev    | 2000800436       | Yes   | Cdevice  | Cdevice   |  Wired |
	  #| LT988-DW | Left       | Right       | Device A | Device B | Device C | Device D       | Yes      | No         | 1700800066 | NoDev    | 1700800149       | Yes     | Cdevice  |  Cdevice  |  Wired |
	 #| RE961-DRWC | Left       | Right       | Device A | Device B | Device C | Device D       | Yes      | No         | 2156716949 | NoDev    | 2156716948       | Yes     | Cdevice  | Cdevice   | D1rechargeableWired|
	 ...
	 #| RU960-DRWC | Left       | Right       | Device A | Device B | Device C | Device D       | Yes      | No         | 4483070777 | NoDev    | 4483181561     | Yes     | 2000816933  | Cdevice   |Rechargeable |
	 | NX977-DWC | Left       | Right       | Device A | Device B | Device C | Device D       | Yes      | No         | 2300806646 | NoDev    | 2300806645     | Yes     | 2000816933  | Cdevice |Rechargeable |
	  #| NX960S-DRWC | Left       | Right       | Device A | Device B | Device C | Device D       | Yes      | No         | 2300803297 | NoDev    | 2300803315     | Yes     | 2000816933  | Cdevice   |Rechargeable |
