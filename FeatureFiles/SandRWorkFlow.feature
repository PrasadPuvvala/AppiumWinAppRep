...
Background:
	Given Importing Test Cases to Excel from TFS TestPlanID "1762234" equivalent to Testcase Configuration "GOP: Dooku3_RIE_Non_RHI(Gallium)" to Create XML.
...
Examples:
	...
	#| LT988-DW     | Left       | Right       | Device A | Device B | Device C | Device D | Yes      | No         | 2286095238 | NoDev    | 1600804950     | Yes     | Cdevice     | Cdevice | Wired               |
	...
	| VI960S-DRWC  | Left       | Right       | Device A | Device B | Device C | Device D | Yes      | No         | 2400811922 | NoDev    | 2400811921     | Yes     | 2400811921  | Cdevice | Rechargeable        |
...
Examples:
	...
	#| LT988-DW     | 1600804950     | Yes     | Right       | Left       | Wired               |
...
Examples:
	...
	#| RT977-DWC     | 2100817052     | Yes     | Right       | Left       | Rechargeable        |
	#| RE977-DWT     | 2026723064     | Yes     | Right       | Left       | Wired               |
	| VI962-DRW     | 2400812374     | Yes     | Right       | Left       | Non-Rechargeable    |
	#| VI960S-DRWC   | 2400811921     | Yes     | Right       | Left       | Rechargeable        |
...
Examples:
	...
	#| LT988-DW     | 1600804950     | Yes     | Right       | Left       | Wired               | capture              | restore              |
...
Examples:
	...
	#| LT988-DW     | 1600804950     | Yes     | Right       | Left       | 2286095238 | Wired               |
	...
	#| RE977-DWT    | 2026489200     | Yes     | Right       | Left       | 2026599583 | Wired               |
	...
	| VI962-DRW    | 2400812374     | Yes     | Right       | Left       | 2400812375 | Non-Rechargeable    |
	#| VI960S-DRWC  | 2400811921     | Yes     | Right       | Left       | 2400811922 | Rechargeable        |
...
#	| LT988-DW     | Left       | Right       | Device A | Device B | Device C | Device D | Temp       | Yes      | No         | 2286095238 | NoDev    | 1600804950     | Yes     | Wired               |
...
Examples:
	...
	#| LT988-DW     | 1600804950     | Yes     | Right       | Left       | 2286095238 | capture       | Wired               |
...
Examples:
	...
	#| LT988-DW     | 1600804950     | Yes     | Right       | Left       | 2286095238 | service records | Wired               |
...
Examples:
	...
	#| LT988-DW     | 1600804950     | Yes     | Right       | Left       | 2286095238 | restore       | Wired               |
...
Examples:
	...
	#| RE962-DRWT   | Left       | Right       | Device A | Device B | Device C | Device D | Temp       | Yes      | No         | 2000803066 | NoDev    | 2000803069     | Yes     | Wired               |
	#| LT961-DRW-UP | Left       | Right       | Device A | Device B | Device C | Device D | Temp       | Yes      | No         | 1700800900 | NoDev    | 2000800436     | Yes     | Wired               |
	#| LT988-DW     | Left       | Right       | Device A | Device B | Device C | Device D | Temp       | Yes      | No         | 2286095240 | NoDev    | 1600804950     | Yes     | Wired               |
