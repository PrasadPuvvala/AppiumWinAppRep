...
Examples:
	...
	#| NX960S-DRWC | 2300803297     | Yes     | Right       | Left       | 2300804252 | Rechargeable |
...
#	| LT961-DRW-UP | Left       | Right       | Device A | Device B | Device C | Device D | Temp       | Yes      | No         | 1700800900 | NoDev    | 2000800436     | Yes     | Wired    |
	...
	#| NX960S-DRWC | Left       | Right       | Device A | Device B | Device C | Device D | Temp       | Yes      | No         | 2300804252 | NoDev    | 2300803297     | Yes     | Rechargeable |
...
Examples:
	...
	#| NX960S-DRWC | 2300803297     | Yes     | Right       | Left       | 2300804252 | capture       | Rechargeable |
	 #| NX977-DWC | 2300806645     | Yes     | Right       | Left       | 2300806646 | capture       |Rechargeable |
...
Examples:
	...
	#| NX960S-DRWC | 2300803297     | Yes     | Right       | Left       | 2300804252 | service records | Rechargeable |
...
Examples:
	...
	#| NX960S-DRWC | 2300803297     | Yes     | Right       | Left       | 2300804252 | restore       | Rechargeable |
	#| NX977-DWC | 2300806645     | Yes     | Right       | Left       | 2300806646 | restore      |Rechargeable |
...
#	 | LT961-DRW-UP | Left       | Right       | Device A | Device B | Device C | Device D       | Yes      | No         | 1700800900 | NoDev    | 2000800436       | Yes   | Cdevice  | Cdevice   |  Wired |
	...
	#| NX960S-DRWC | Left       | Right       | Device A | Device B | Device C | Device D | Yes      | No         | 2300807478 | NoDev    | 2300803297     | Yes     | 2000816933  | Cdevice | Rechargeable |
...
#	| LT961-DRW-UP | Left       | Right       | Device A | Device B | Device C | Device D | Temp       | Yes      | No         | 1700800900 | NoDev    | 2000800436     | Yes     |Wired |
	...
	#| RT961-DRWC | Left       | Right       | Device A | Device B | Device C | Device D | Temp       | Yes      | No         | 2000816934 | NoDev    | 2000816936    | Yes     |Rechargeable |
    #| NX977-DWC | Left       | Right       | Device A | Device B | Device C | Device D | Temp       | Yes      | No         | 2300806646 | NoDev    | 2300806645     | Yes     |Rechargeable |
	#| NX960S-DRWC | Left       | Right       | Device A | Device B | Device C | Device D | Temp       | Yes      | No         | 2300807478 | NoDev    | 2300807477     | Yes     | Rechargeable |
     #| RU960-DRWC | Left       | Right       | Device A | Device B | Device C | Device D | Temp       | Yes      | No         | 4483070777 | NoDev    | 4483181561     | Yes     |Rechargeable |
