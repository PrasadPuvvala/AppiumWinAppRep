...
    When [Verify StorageLayout Scenario By Changing Date and Confirm Cloud Icon "<DeviceId>" and "<DeviceLeft>" and "<DeviceLeftSlNo>"]
    ...
    | RE962-DRW |  2026335112    | Yes     | Right       | Left       |
...
##	| LT961-DRW-UP | 2000800436     | Yes     | Right       | Left       |            |
    | RE962-DRW    | 2026335112     | Yes     | Right       | Left       | 2049043374 |
...
    When [Get the dump of connected device by storage layout "<DeviceId>" and "<DeviceTemp>" and "<DeviceSlNo>"]
	...
	| DeviceId     | DeviceLeft | DeviceRight | DumpA    | DumpB    | DumpC    | DeviceTemp | AlterFSW | AlterFSWNo | DeviceSlNo | NoDevice | DeviceLeftSlNo   | FlashHI | 
	 ...
	 | RE962-DRW   | Left       | Right       | Device A | Device B | Device C | Temp       | Yes      | No         | 2049043374 | NoDev    | 2026335112       | Yes     |
...
@tag11 
  ...
  | RE962-DRW | Left       | Right       | Device A | Device B | Device C | Device D | Temp       | Yes      | No         | 2049043374  | NoDev        | 2026335112     | Yes     |
...
Examples:
	...
	| RE962-DRW | 2026335112     | Yes     | Right       | Left       | 2049043374 |  capture |
...
    When [Verify StorageLayout Scenario By Changing Date and Confirm Cloud Icon "<DeviceId>" and "<DeviceLeft>" and "<DeviceLeftSlNo>"]	
	...
	| RE962-DRW | 2026335112    | Yes     | Right       | Left       | 2049043374 |  service records |
	...
	| RE962-DRW | 2026335112     | Yes     | Right       | Left       | 2049043374 |  restore |
